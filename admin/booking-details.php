...
<tr>
<th>Audition LInk</th>    
<td colspan="5"><a href="<?php echo htmlentities($row->audition);?>"><?php echo htmlentities($row->audition);?></a></td>
</tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="adminremark" method="post">
          <p><textarea  placeholder="Admin remark" class="form-control" name="adminremark" required></textarea></p>
