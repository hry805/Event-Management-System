...
<html class="no-js" lang="en">
    ...
    <body>
       ...
       <!-- Slider Caption 1 -->
                    <div id="htmlcaption1" class="nivo-html-caption slider-caption-1" >
                        <div class="container">
                            ...
                            <div class="cap-dec wow fadeInDown" data-wow-duration=".9s" data-wow-delay="0.2s" style="margin-top:-100px">
                                        ...
                                        <h1 class="text-esystems" align="center">Event Management System</h1>
                                        <h1 class="text-esystems" align="center">Event Management System</h1>
                                        </div>
                                    </div>
            ...
            <div class="upcomming-events-area off-white ptb100 colors-events">
                  <div class="container">
                      <div class="row">
                          <div class="col-xs-12">
                           <h1 class="section-title white-color">Up Comming Events</h1>
                        </div>
...
{ 
    ?>
                              ...
                              <div class="single-upcomming shadow-box">
                                 ...
                                 <div class="upcomming-ticket text-center">
                                    <div class="bodys1">
                                    <a href="event-details.php?evntid=<?php echo htmlentities($row->id);?>" class="btns-detail">View Details
 ...
 <?php } } ?>                        
            ...
            <!--Counter area start-->
            <!-- <div class="counter-area pb150 colors-events">
                <div class="container">
                    <div class="row">
            ...
            <div class="call-to-action bg-overlay white-overlay pb100 pt85  colors-events">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="cal-to-wrap">
                                <h1 class="section-title white-color font-style">Enter Your Email Address For <br> Events & News</h1>
                                <form method="post" name="subscribe">
                                    <div class="input-box">
                                        <input type="email" placeholder="Enter your E-mail Address" class="info input-border" name="email" required="true"> 
                                        <div class="bodys2">

                                            <button type="submit" name="subscribe" class="send-btn btns-detail">  <span class="span1"> </span>
                                            <span class="span1"> </span>
                                            <span class="span1"> </span>
                                            <span class="span1"> </span> <i class="zmdi zmdi-mail-send"> </i>
