         ...
         <div class="wrapper single-blog">
           ...
           <!--slider header area are end-->
            ...
            <div class="contecting" style="top:45%">
                                        <h1 class="text-esystems" align="center">All EVENTS</h1>
                                        <h1 class="text-esystems" align="center">All EVENTS</h1>
                                        </div>
                </div>
            </div> 
...
{ 
?>
                           <h1 class="section-title white-color"><?php echo htmlentities($row->CategoryName);?> Category Event Details</h1>
                       <?php }} ?>
                        </div>
                          <div class="total-upcomming-event col-lg-12 col-12 col-xs-12">
                                 ...
                                 <div class="col-md-3 col-sm-4 col-xs-12">
                                     <div class="upcomming-ticket text-center">
                                        <div class="bodys1">
                                            ...
                                            <a href="event-details.php?evntid=<?php echo htmlentities($row->id);?>" class="btns-detail5">View Details
