...
echo $sql="INSERT INTO tblbookings(BookingId,UserId,EventId,NumberOfMembers,UserRemark,audition) VALUES(:bokkingid,:userid,:eid,:noofmembers,:usrremark,:audition)";
//preparing the query
...
$query->bindParam(':audition',$audition,PDO::PARAM_STR);
//Execute the query
$query->execute();
         ...
         <div id="home" class="wrapper event-details">
           ...
           <!--slider header area are end-->
            ...
            <div class="contecting" style="top:45%">
                                        <h1 class="text-esystems" align="center">EVENT DETAILS</h1>
                                        <h1 class="text-esystems" align="center">EVENT DETAILS</h1>
                                        </div>
                </div>
            </div> 
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p><input type="text" placeholder="Number of members" class="info" name="noofmembers" required></p>
          <p><textarea  placeholder="User remark" class="info" name="userremark" required></textarea></p>
          
          <p><textarea  placeholder="Audition Link" class="info" name="audition" required></textarea></p>
