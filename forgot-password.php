        ...
        <!--body-wraper-are-start-->
         <div class="wrapper single-blog">
           ...
           <!--slider header area are end-->
            ...
            <!-- <h1 class="header12" style="color: white;">About Us</h1> -->
            <div class="contecting" style="top:45%">
                                        <h1 class="text-esystems" align="center">Forgot Password</h1>
                                        <h1 class="text-esystems" align="center">Forgot Password</h1>
                                        </div>
                </div>
            </div> 
            ...
            <div class="single-blog-area ptb100 fix">
               <div class="container">
                   <div class="row">
                       <div class="col-md-7 col-12 text-center" style=" background-color: black; border:1px solid black; border-radius:12px !important;    ">
                           <div class="single-blog-body">


                        
                                <div class="Leave-your-thought mt50">
                                    <h3 class="aside-title uppercase white-color">User Forgot Password (Password Recovery)</h3>
                                    <div class="row">
            <form method="post" >
                                            <div class="col-md-12 col-sm-6 col-xs-12 lyt-left">
                                                <div class="input-box leave-ib">
<input type="text" placeholder="Username" class="info inputsign " name="username" required="true">

<input type="text" name="phonenumber" placeholder="Reg Phone Number"  class="info inputsign" required /> 

</div>
                                            </div>
                                       
<div class="col-lg-12 mt10" style=" display:flex; justify-content:center;">
<div class="input-box post-comment">
<input type="submit" value="Submit" name="passwordrecovery" class="submit uppercase"> 
</div>
</div>

 <div class=" col-lg-12 col-xs-12 mt30 mb10" style="display: flex; justify-content:center;">
 <div class="input-box post-comment text-center " style="color:blue;"> 
  Already an account <a href="signin.php" style="color: white !important;"> Login here</a>
</div>
</div>
</form>
